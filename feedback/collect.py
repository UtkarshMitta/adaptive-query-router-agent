                ...
                "messages": [
                    ...
                    {"role": "user", "content": entry["query"]},
                    {
                        ...
                        "content": json.dumps({
                            ...
                            "confidence": 0.95,  # High confidence for human-labeled
                        }),
                    },
                ]
            }
...
def main():
    ...
    parser.add_argument("--export", type=str, help="Export feedback as training JSONL")
    ...
    if args.add:
        ...
        print(f"💾 Exported {len(examples)} training examples to {args.export}")
